        ...
        ?><div class="gt3_blockquote__author_wrapper"><?php 
            ...
            ?><div class="gt3_blockquote__author_container"><?php 
                if (!empty($settings['image']) && !empty($settings['image']['id'])) {
                    ...
                    $avatar = '<div class="gt3_blockquote__author_photo"><img src="'.esc_url($src).'" style="width:'.esc_attr((int)$settings['image_size']['size']).'px;height:'.esc_attr((int)$settings['image_size']['size']).'px;" alt="" /></div>';
