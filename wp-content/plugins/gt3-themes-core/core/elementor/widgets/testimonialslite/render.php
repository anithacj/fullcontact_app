						...
						<div class="testimonial_item_wrapper">
							<div class="testimonials_content">
								...
								if(!empty($settings['author_position']) && $settings['author_position'] == 'around' && $settings['avatar_slider'] != true) {
									echo '<div class="testimonials_author_wrapper">'.$photo.'</div>';
									$photo = '';
								}
								...
								if (!($settings['items_per_line'] == '1' && $settings['image_position'] != 'aside' && $settings['avatar_slider'] == true)) {
									if ( 
										...
										echo '<div class="testimonials_author_wrapper">'. wp_kses_post( apply_filters( 'gt3/core/render/TestimonialsLite/block_wrap_start', '' ) ) . $title . wp_kses_post( apply_filters( 'gt3/core/render/TestimonialsLite/block_wrap_end', '' ) ) . $photo . '</div>';
									}else{
										echo '<div class="testimonials_author_wrapper">' . $photo . wp_kses_post( apply_filters( 'gt3/core/render/TestimonialsLite/block_wrap_start', '' ) ) . $title . wp_kses_post( apply_filters( 'gt3/core/render/TestimonialsLite/block_wrap_end', '' ) ) . '</div>';
									}
								}

								if($settings['items_per_line'] == '1' && !empty($settings['author_position']) && $settings['author_position'] == 'around' && $settings['avatar_slider'] == true) {
									echo '<div class="testimonials_author_wrapper">'.$title.'</div>';
									$photo = '';
								}							
