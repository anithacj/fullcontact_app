       ...
       if ( 'column' === $element->get_name() && 'section_style' === $section_id ) {
        ...
        if ( 'column' === $element->get_name() && 'section_style' === $section_id ) {
            ...
            $element->add_control(
                'gt3_tabs',
                array(
                    'label' => esc_html__('Tabs', 'gt3_themes_core'),
                    'type'  => Elementor\Controls_Manager::SWITCHER,
                )
            );
            ...
            $element->add_responsive_control(
                ...
                array(
                    ...
                    'selectors' => array(
                        '{{WRAPPER}} .gt3_column_tabs_nav > li > a' => 'border-radius: {{SIZE}}{{UNIT}};',
                        '{{WRAPPER}} .gt3_column_tabs_nav' => 'border-radius: {{SIZE}}{{UNIT}};',
                    ),
                )
            );
            ...
            $element->start_controls_tabs('tabs_colors');
            $element->start_controls_tab('tabs_colors_normal_state',
                [
            ...
            $element->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .gt3_column_tabs_nav > li > a' => 'color: {{VALUE}};',
                    ],
                ]
            );
            $element->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .gt3_column_tabs_nav > li > a i' => 'color: {{VALUE}};',
                    ],
                ]
            );
            /*$element->add_control(
                'tabs_bg_color',
                [
                    'label' => __( 'Background Color', 'gt3_themes_core' ),
                    'type' => Elementor\Controls_Manager::COLOR,
                    'scheme' => [
                        'type' => Elementor\Scheme_Color::get_type(),
                        'value' => Elementor\Scheme_Color::COLOR_1,
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .gt3_column_tabs_nav > li > a' => 'background-color: {{VALUE}};',
                        '{{WRAPPER}} .gt3_column_tabs_nav' => 'background-color: {{VALUE}};',
                        '{{WRAPPER}}.gt3_tabs_marker-yes .gt3_column_tabs_nav > li > a:after' => 'color: {{VALUE}};',
                    ],
                ]
            );*/
            ...
            $element->add_group_control(
                ...
                [
                    ...
                    'fields_options' => array(
                        ...
                        'color' => [
                            'selectors' => [
                                '{{WRAPPER}} .gt3_column_tabs_nav > li > a, {{WRAPPER}} .gt3_column_tabs_nav' => 'background-color: {{VALUE}}; background-image: none;',
                                '{{WRAPPER}}.gt3_tabs_marker-yes .gt3_column_tabs_nav > li > a:after' => 'color: {{VALUE}}; background-image: none;',
                            ],
                        ],
                        'gradient_angle' => [
                            'default' => [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .gt3_column_tabs_nav > li > a, {{WRAPPER}} .gt3_column_tabs_nav' => 'background-color: transparent; background-image: linear-gradient({{SIZE}}{{UNIT}}, {{color.VALUE}} {{color_stop.SIZE}}{{color_stop.UNIT}}, {{color_b.VALUE}} {{color_b_stop.SIZE}}{{color_b_stop.UNIT}});',
                                '{{WRAPPER}}.gt3_tabs_marker-yes .gt3_column_tabs_nav > li > a:after' => 'background-color: transparent; background-image: none; opacity: 0;',
                            ],
                        ],
                    ),
                ]
            ...
            $element->start_controls_tab('tabs_colors_hover_state',
                [
            ...
            $element->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .gt3_column_tabs_nav > li.ui-tabs-active > a, {{WRAPPER}} .gt3_column_tabs_nav_wrapper.ui-state-active .gt3_column_tabs_nav > li > a' => 'color: {{VALUE}};',
                    ],
                ]
            );
            $element->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .gt3_column_tabs_nav > li.ui-tabs-active > a .gt3_column_tabs_nav__icon,{{WRAPPER}} .gt3_column_tabs_nav_wrapper.ui-state-active .gt3_column_tabs_nav > li > a .gt3_column_tabs_nav__icon' => 'color: {{VALUE}};',
                    ],
                ]
            );
            /*$element->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .gt3_column_tabs_nav > li.ui-tabs-active > a, {{WRAPPER}} .gt3_column_tabs_nav_wrapper.ui-state-active .gt3_column_tabs_nav > li > a' => 'background-color: {{VALUE}};',
                        '{{WRAPPER}}.gt3_tabs_marker-yes .gt3_column_tabs_nav > li.ui-tabs-active > a:after, {{WRAPPER}}.gt3_tabs_marker-yes .gt3_column_tabs_nav_wrapper.ui-state-active .gt3_column_tabs_nav > li > a:after' => 'color: {{VALUE}};',
                    ],
                ]
            );*/
            ...
            $element->add_group_control(
                ...
                [
                    ...
                    'fields_options' => array(
                        ...
                        'color' => [
                            'selectors' => [
                                '{{WRAPPER}} .gt3_column_tabs_nav > li.ui-tabs-active > a, {{WRAPPER}} .gt3_column_tabs_nav_wrapper.ui-state-active .gt3_column_tabs_nav > li > a' => 'background-color: {{VALUE}}; background-image: none;',
                                '{{WRAPPER}}.gt3_tabs_marker-yes .gt3_column_tabs_nav > li.ui-tabs-active > a:after, {{WRAPPER}}.gt3_tabs_marker-yes .gt3_column_tabs_nav_wrapper.ui-state-active .gt3_column_tabs_nav > li > a:after' => 'color: {{VALUE}}; background-image: none;',
                            ],
                        ],
                        'gradient_angle' => [
                            'default' => [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .gt3_column_tabs_nav > li.ui-tabs-active > a, {{WRAPPER}} .gt3_column_tabs_nav_wrapper.ui-state-active .gt3_column_tabs_nav > li > a' => 'background-color: transparent; background-image: linear-gradient({{SIZE}}{{UNIT}}, {{color.VALUE}} {{color_stop.SIZE}}{{color_stop.UNIT}}, {{color_b.VALUE}} {{color_b_stop.SIZE}}{{color_b_stop.UNIT}});',
                                '{{WRAPPER}}.gt3_tabs_marker-yes .gt3_column_tabs_nav > li.ui-tabs-active > a:after, {{WRAPPER}}.gt3_tabs_marker-yes .gt3_column_tabs_nav_wrapper.ui-state-active .gt3_column_tabs_nav > li > a:after' => 'background-color: transparent; background-image: none; opacity: 0;',
                            ],
                        ],
                    ),
                ]
            ...
            $repeater->add_responsive_control(
                ...
                array(
                    ...
                    'selectors' => array(
                        '{{WRAPPER}} {{CURRENT_ITEM}} .gt3_column_tabs_nav__image_container' => 'max-width: {{SIZE}}{{UNIT}};',
                        '{{WRAPPER}} {{CURRENT_ITEM}} .gt3_column_tabs_nav__icon' => 'font-size: {{SIZE}}{{UNIT}};',
                    ),
                )
            );
            ...
            $repeater->add_control(
                ...
                [
                    ...
                    'default' => '',
                    'selectors' => [
                        '{{WRAPPER}} .gt3_column_tabs_nav > li{{CURRENT_ITEM}} > a' => 'color: {{VALUE}};',
                    ],
                ]
            );
            $repeater->add_control(
                ...
                [
                    ...
                    'default' => '',
                    'selectors' => [
                        '{{WRAPPER}} .gt3_column_tabs_nav > li{{CURRENT_ITEM}} > a .gt3_column_tabs_nav__icon' => 'color: {{VALUE}};',
                    ],
                    'condition' => [
                        'type' => 'icon',
                    ],
            ...
            /*$repeater->add_control(
                ...
                [
                    ...
                    'default' => '',
                    'selectors' => [
                        '{{WRAPPER}} .gt3_column_tabs_nav > li{{CURRENT_ITEM}} > a' => 'background-color: {{VALUE}};',
                        '{{WRAPPER}}.gt3_tabs_marker-yes .gt3_column_tabs_nav > li{{CURRENT_ITEM}} > a:after' => 'color: {{VALUE}};',
                    ],
                ]
            );*/
            ...
            $repeater->add_group_control(
                ...
                [
                    ...
                    'fields_options' => array(
                        ...
                        'color' => [
                            'selectors' => [
                                '{{WRAPPER}} .gt3_column_tabs_nav > li{{CURRENT_ITEM}} > a' => 'background-color: {{VALUE}}; background-image: none;',
                                '{{WRAPPER}}.gt3_tabs_marker-yes .gt3_column_tabs_nav > li{{CURRENT_ITEM}} > a:after' => 'color: {{VALUE}}; background-image: none;',
                            ],
                        ],
                        'gradient_angle' => [
                            'default' => [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .gt3_column_tabs_nav > li{{CURRENT_ITEM}} > a' => 'background-color: transparent; background-image: linear-gradient({{SIZE}}{{UNIT}}, {{color.VALUE}} {{color_stop.SIZE}}{{color_stop.UNIT}}, {{color_b.VALUE}} {{color_b_stop.SIZE}}{{color_b_stop.UNIT}});',
                                '{{WRAPPER}}.gt3_tabs_marker-yes .gt3_column_tabs_nav > li{{CURRENT_ITEM}} > a:after' => 'background-color: transparent; background-image: none; opacity: 0;',
                            ],
                        ],
                    ),
                ]
            ...
            $repeater->add_control(
                ...
                [
                    ...
                    'default' => '',
                    'selectors' => [
                        '{{WRAPPER}} .gt3_column_tabs_nav > li.ui-tabs-active{{CURRENT_ITEM}} > a, {{WRAPPER}} .gt3_column_tabs_nav_wrapper.ui-state-active .gt3_column_tabs_nav > li{{CURRENT_ITEM}} > a' => 'color: {{VALUE}};',
                    ],
                ]
            );
            $repeater->add_control(
                ...
                [
                    ...
                    'default' => '',
                    'selectors' => [
                        '{{WRAPPER}} .gt3_column_tabs_nav > li.ui-tabs-active{{CURRENT_ITEM}} > a .gt3_column_tabs_nav__icon,
                        {{WRAPPER}} .gt3_column_tabs_nav_wrapper.ui-state-active .gt3_column_tabs_nav > li{{CURRENT_ITEM}} > a .gt3_column_tabs_nav__icon' => 'color: {{VALUE}};',
                    ],
                    'condition' => [
                        'type' => 'icon',
                    ],
           ...
           /* $repeater->add_control(
                ...
                [
                    ...
                    'default' => '',
                    'selectors' => [
                        '{{WRAPPER}} .gt3_column_tabs_nav > li.ui-tabs-active{{CURRENT_ITEM}} > a, {{WRAPPER}} .gt3_column_tabs_nav_wrapper.ui-state-active .gt3_column_tabs_nav > li{{CURRENT_ITEM}} > a' => 'background-color: {{VALUE}};',
                        '{{WRAPPER}}.gt3_tabs_marker-yes .gt3_column_tabs_nav > li.ui-tabs-active{{CURRENT_ITEM}} > a:after, {{WRAPPER}}.gt3_tabs_marker-yes .gt3_column_tabs_nav_wrapper.ui-state-active .gt3_column_tabs_nav > li{{CURRENT_ITEM}} > a:after' => 'color: {{VALUE}};',
                    ],
                ]
            );
*/
            ...
            $repeater->add_group_control(
                ...
                [
                    ...
                    'fields_options' => array(
                        ...
                        'color' => [
                            'selectors' => [
                                '{{WRAPPER}} .gt3_column_tabs_nav > li.ui-tabs-active{{CURRENT_ITEM}} > a, {{WRAPPER}} .gt3_column_tabs_nav_wrapper.ui-state-active .gt3_column_tabs_nav > li{{CURRENT_ITEM}} > a' => 'background-color: {{VALUE}}; background-image: none;',
                                '{{WRAPPER}}.gt3_tabs_marker-yes .gt3_column_tabs_nav > li.ui-tabs-active{{CURRENT_ITEM}} > a:after, {{WRAPPER}}.gt3_tabs_marker-yes .gt3_column_tabs_nav_wrapper.ui-state-active .gt3_column_tabs_nav > li{{CURRENT_ITEM}} > a:after' => 'color: {{VALUE}}; background-image: none;',
                            ],
                        ],
                        'gradient_angle' => [
                            'default' => [
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .gt3_column_tabs_nav > li.ui-tabs-active{{CURRENT_ITEM}} > a, {{WRAPPER}} .gt3_column_tabs_nav_wrapper.ui-state-active .gt3_column_tabs_nav > li{{CURRENT_ITEM}} > a' => 'background-color: transparent; background-image: linear-gradient({{SIZE}}{{UNIT}}, {{color.VALUE}} {{color_stop.SIZE}}{{color_stop.UNIT}}, {{color_b.VALUE}} {{color_b_stop.SIZE}}{{color_b_stop.UNIT}});',
                                '{{WRAPPER}}.gt3_tabs_marker-yes .gt3_column_tabs_nav_wrapper.ui-state-active .gt3_column_tabs_nav > li{{CURRENT_ITEM}} > a:after' => 'background-color: transparent; background-image: none; opacity: 0;',
                            ],
                        ],
                    ),
                ]
            ...
            $element->add_control(
                ...
                array(
                    ...
                    'default'     => array(
                        array(
                            'tab_title'   => esc_html__('Tab #1', 'gt3_themes_core'),
                        ...
                        array(
                            'tab_title'   => esc_html__('Tab #2', 'gt3_themes_core'),
                        ...
                        array(
                            'tab_title'   => esc_html__('Tab #3', 'gt3_themes_core'),
...
if (!function_exists('gt3_column_before_render_options')) {
    function gt3_column_before_render_options( $element ) {
      ...
      if ( ! empty( $settings['gt3_tabs'] ) ) {
        $element->add_script_depends('jquery-ui-tabs');
        wp_enqueue_style('jquery-ui');

        $element->add_script_depends('jquery-ui-accordion');
        wp_enqueue_style('jquery-ui');


        $data_settings = array();
        $data_settings['gt3_tabs_active'] = !empty($settings['gt3_tabs_active']) ? (int)$settings['gt3_tabs_active'] - 1 : 0;
        $data_settings['gt3_tabs_type'] = !empty($settings['gt3_tabs_type']) ? $settings['gt3_tabs_type'] : '';


        $data_tab_items = array();

        if (!empty($settings['items']) && is_array($settings['items'])) {
            foreach ($settings['items'] as $key => $item) {
                if (!empty($item['tab_title'])) {
                    $data_tab_items[$key]['title'] = $item['tab_title'];
                }
                if (!empty($item['icon'])) {
                    $data_tab_items[$key]['icon'] = $item['icon'];
                }
                if (!empty($item['type'])) {
                    $data_tab_items[$key]['type'] = $item['type'];
                }
                if (!empty($item['image'])) {
                    $data_tab_items[$key]['image'] = $item['image'];
                }
                if (!empty($item['image_hover'])) {
                    $data_tab_items[$key]['image_hover'] = $item['image_hover'];
                }
                if (!empty($item['gt3_tabs_icon_size'])) {
                    $data_tab_items[$key]['gt3_tabs_icon_size'] = $item['gt3_tabs_icon_size'];
                }
                if (!empty($item['_id'])) {
                    $data_tab_items[$key]['_id'] = $item['_id'];
                }
            }
            if (!empty($data_tab_items)) {
                $element->add_render_attribute( '_wrapper', 'data-tab-items', json_encode( $data_tab_items ) );
            }
        }

        if ($settings['gt3_tabs_type'] === 'vertical') {
            $element->add_render_attribute( '_wrapper', 'class', 'gt3_column_tabs-type_vertical' );
        }

        $element->add_render_attribute( '_wrapper', 'data-settings', json_encode( $data_settings ) );
        $element->add_render_attribute( '_wrapper', 'class', 'gt3_column_tabs-elementor' );
...
if (!function_exists('gt3_add_widget_to_theme')) {
    function gt3_add_widget_to_theme($extra_widget=array()){
        ...
        if (in_array('team_info',$extra_widget)) {
            require_once plugin_dir_path( dirname( __FILE__ ) ) . 'core/widgets/team_info.php';
        }
        if (in_array('posts_list',$extra_widget)) {
            require_once plugin_dir_path( dirname( __FILE__ ) ) . 'core/widgets/posts_list.php';
        }
        if (in_array('team_list',$extra_widget)) {
            require_once plugin_dir_path( dirname( __FILE__ ) ) . 'core/widgets/team_list.php';
        }
    }
}
    ...
    function gt3_blog_post_sharing($show_share = false,$featured_image=false){
        if ($show_share == "1") { ?>
            ...
            <div class="post_share_block">
                <a href="<?php echo esc_js("javascript:void(0)"); ?>"><span class="sharing_title"><?php echo esc_html__('Share', 'gt3_themes_core'); ?></span></a>
